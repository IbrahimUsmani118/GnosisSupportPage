# Gnosis-Social-Support-Page

_Last updated: **October 2025**_

Welcome to the **Gnosis** Support page. This page answers the most common questions about accounts, messages, image uploads (including our duplicate-image blocking), app permissions, privacy, and how to get help.
...
We request permissions **only when needed**, and you can change them anytime in **Settings → Gnosis**:
...
> If a feature isn’t working, confirm the permission is enabled for Gnosis.
...
- iOS **Settings → Notifications → Gnosis** → allow Alerts & Badges.
